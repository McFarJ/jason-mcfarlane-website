...
class Cookie extends React.Component{
    ...
    handleClick(){
        this.props.setOpenCookie(this.props.cookieNumber)
        $(`.nav__cookie${this.props.cookieNumber}`).css('display', 'none')
        $(`.nav__cookie-opened${this.props.cookieNumber}`).css('display', 'block').addClass('nav__winning-cookie')
        $('.nav__cookie').removeClass('nav__cookie_has-hover')
        $('.nav__menu-option').css('pointer-events', 'none')
        $('.fortune').fadeIn( "slow" )
        $(`.fortune__text${this.props.cookieNumber}`).fadeIn("slow").addClass('fortune__text_told')
        $('.nav__thanks-wrapper').delay(2000).fadeIn(3000)
        this.props.setFortuneTold()
    }

    render(){
        return(
            <div>
                <svg className={`nav__cookie nav__cookie_has-hover nav__cookie${this.props.cookieNumber}`} onClick={this.handleClick} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                viewBox="0 0 100 125" xmlSpace="preserve">
                    ...
                    <g className="cookie-foreground">
                        ...
                        <path className="cookie-outline" d="M87.1,62.1c-0.2,0.6-0.3,0.7-0.6,1.2c-0.3,0.4-1.3,0.4-1.5,1.1c-0.2,0.7,0,1.5-0.2,2.4c-0.1,0.9-0.2,0.2-0.8,0.7
                        ...
                        <path className="cookie-outline" d="M84.6,31.2C75,25.6,72.9,14.8,55.5,14.8c-19.4,0-41,20.9-47.7,24c-5.1,2.4-2.1,7.9,2.1,8.7c4.2,0.8,9.7,2.2,16.1,2.7
                ...
                <svg className={`nav__cookie-opened nav__cookie-opened${this.props.cookieNumber}`} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 100 125" xmlSpace="preserve">
                    <g>
                        <path className="cookie-outline" d="M98.7,33.9l-3.8-18.7l-0.1-0.5l-0.5,0.1c-5.3,1.5-8.9,2.3-11.9,3c-3.8,0.9-6.3,1.5-9.4,2.7c-3.2-3.4-8.2-5.8-17.5-5.8
                        ...
                        <path className="cookie-outline" d="M75.9,66.1c-5-3.9-6.6-3.8-11.5-3.1c-1.4,0.2-18.9,6-21.5,8.1c-0.4,0.3-3.9,3.2-6.3,4.7c-3.3,2.1-11.9,5.8-13.7,7.6
                        ...
                        <path className="cookie-outline" d="M90.1,59.1c0.1,0,0.3,0,0.4,0c-0.6,0-1.2-0.1-1.8-0.3c0,0,0,0,0,0c0,0,0,0.1,0,0.1C88.7,58.9,89.9,59.1,90.1,59.1z"/>
                        <path className="cookie-outline" d="M87.1,58.3c-0.3,0.1-0.5,0.2-0.8,0.3c-0.6,0.3-1.1,0.6-1.6,0.9c0.4-0.1,0.8-0.2,1.3-0.4C86.5,58.9,86.7,58.5,87.1,58.3z"/>
                        <path className="cookie-outline" d="M93.3,59.4c-0.1,0-0.2-0.1-0.3-0.1c0.1,0.1,0.3,0.1,0.3,0.2c0.6,0.5,0.3,1.2,0,1.7c-0.6,1.1-2.4-0.1-3.1,1.1
                            ...
                            />
                        <path className="cookie-outline" d="M88.2,58.4c-0.1-0.1-0.3-0.1-0.4-0.1c0,0,0,0,0,0C87.9,58.4,88.1,58.4,88.2,58.4z"/>
                        <path className="cookie-outline" d="M84.1,54c0.1,0,0.2-0.2,0.1-0.2c-0.2-0.1,0.7-0.2,0.8-0.2c0.3-0.1,0-0.1,0.2-0.3c0.3-0.3,0.1-0.5-0.1-0.7c0,0,0,0,0,0
                        ...
                        <path className="cookie-outline" d="M70.2,56.9c0.1-0.1,0.3-0.2,0.4-0.3c0.6-0.3,0.3-0.1,1.2-0.2c0,0,0.1,0,0.1,0c0.1,0,0.1,0,0.2,0c0.1,0,0.2,0,0.4-0.1
